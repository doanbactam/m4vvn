...
const EmailSubmissionExpedited = ({ tool, ...props }: EmailProps) => {
  return (
    <EmailWrapper {...props}>
      ...
      <Text>
        Thanks for submitting {tool?.name}, it will now be reviewed and added to
        our directory <strong>within 24 hours</strong>. If you want your tool
        published on a specific date, please let us know. We'll do our best to
        meet your request.
      </Text>
