...
const EmailSubmission = ({ tool, queueLength = 100, ...props }: EmailProps) => {
  return (
    <EmailWrapper {...props}>
      ...
      <Text>
        Thanks for submitting {tool?.name}, it'll be reviewed shortly!
      </Text>
      ...
      {queueLength > 10 && (
        <>
          <Text>
            ...
            there's a bit of a queue. {tool?.name} is scheduled to be added in
            approximately{' '}
            <strong className="whitespace-nowrap">
              {getQueueLength(queueLength)}
            </strong>
            . However, if you'd like to fast-track your submission, you have the
            option to skip the queue.
          </Text>
