    ...
    <>
      <Intro alignment="center">
        ...
        <IntroDescription className="max-w-3xl">
          Promote your business or software and reach a wide audience of open
          source enthusiasts. Check our{' '}
          <a
            href={config.links.analytics}
            target="_blank"
      ...
      >
        <p className="text-sm text-muted-foreground">
          Join these companies in advertising their business on{' '}
          {config.site.name}
        </p>
      ...
      <Intro alignment="center" className="md:my-4 lg:my-8">
        ...
        <IntroDescription className="max-w-lg">
          Tell us more about your company and we will get back to you as soon as
          possible.
        </IntroDescription>
