...
export const Footer = ({ children, className, hideNewsletter, ...props }: FooterProps) => {
  return (
    ...
    >
      ...
      <div className="flex flex-row flex-wrap items-end justify-between gap-x-4 gap-y-2 w-full text-sm text-muted-foreground **:data-link:font-medium **:data-link:text-foreground **:data-link:hover:text-secondary-foreground">
        <Stack size="sm">
          <span>Built with</span>

          <ExternalLink href={config.links.madeWith} className="contents" data-link doFollow>
            <svg
